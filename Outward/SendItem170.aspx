<%@ Page Title="RTGS Outward: Send" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="SendItem170.aspx.cs" Inherits="RtgsWeb.Outward.SendItem170" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width: 100%">
        ...
        <fieldset id="fsLinks" runat="server" class="formBoxGV">
            <legend>
                <asp:Label ID="LabelBank" runat="server" Text="Outward Items & ILF Returns to Send"></asp:Label></legend>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="LinkButtonRej" runat="server" ForeColor="Red"
                                OnClientClick="return window.confirm('Are you sure to Reverse the item?');"
                                OnClick="ButtonDeleteItemYesClick">Reverse</asp:LinkButton>
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="LinkButton1" runat="server" ForeColor="Blue" OnClientClick="return window.confirm('Are you sure to Send the item?') & loading();"
