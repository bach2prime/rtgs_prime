<%@ Page Title="RTGS Outward: Item Add/Edit" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EditItemInst170.aspx.cs" Inherits="RtgsWeb.Outward.EditItemInst170" %>
                    ...
                    <table style="width: 100%" cellpadding="10" cellspacing="0" class="dataEntryTable">
                        ...
                        <tr class="oddRow">
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="ddlCurrency" runat="server" OnSelectedIndexChanged="ddlCurrency_OnSelectedIndexChanged"
                                    AutoPostBack="true">
                                </asp:DropDownList>
                                 &nbsp;&nbsp; 
                        ...
                        <tr class="oddRow">
                            ...
                            <td>
                                ...
                                &nbsp;&nbsp;
                                <asp:TextBox ID="tbOtherRt" Width="120px" ReadOnly="true" runat="server" MaxLength="0"
                                    CssClass="textBox"></asp:TextBox>
