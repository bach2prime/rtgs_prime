<%@ Page Title="RTGS Outward: Remake" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="InwardReturn.aspx.cs" Inherits="RtgsWeb.Outward.InwardReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div style="width: 100%">
        ...
        <fieldset id="itemList" runat="server" class="formBoxGV">
            <legend>
                <asp:Label ID="Label1" runat="server" Text="Inward Reverse Items"></asp:Label></legend>
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="">
                        ...
                        <ItemTemplate>
                            ...
                            &nbsp;&nbsp;&nbsp;&nbsp;
                            <asp:LinkButton ID="LinkButtonRm" runat="server" ForeColor="Green" OnClick="UpdateItem">Repair</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
