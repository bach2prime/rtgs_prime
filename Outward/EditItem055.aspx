<%@ Page Title="RTGS Outward: Item Add/Edit" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="EditItem055.aspx.cs" Inherits="RtgsWeb.Outward.EditItem055" %>
                ...
                <td style="width: 800px" valign="top">
                    ...
                    <table style="width: 100%" cellpadding="8" cellspacing="0" class="dataEntryTable">
                        ...
                        <tr class="evenRow">
                            ...
                            <td>
                                <asp:TextBox ID="tbSenderAcc" Width="220px" runat="server" OnTextChanged="tbSenderAcc_OnTextChanged" AutoPostBack="True" CssClass="textBox" MaxLength="0"></asp:TextBox>
                                &nbsp;&nbsp;&nbsp;
