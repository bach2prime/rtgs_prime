<%@ Page Title="RTGS Outward: Status" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="ItemStatus170.aspx.cs" Inherits="RtgsWeb.Outward.ItemStatus170" %>
            ...
            <tr>
                ...
                <td style="width: 67%">
                    <fieldset id="Fieldset1" runat="server" class="formBoxGV">
                        ...
                        <asp:LinkButton CssClass="linkButton" OnClick="LinkButtonClicked" runat="server"
                            ID="linkReversed">Reversed (0)</asp:LinkButton>
                        <b>
                            <asp:HyperLink runat="server" ID="linkSendOutward" NavigateUrl="">Send Outward</asp:HyperLink></b>
                    </fieldset>
                </td>
                <td>
                    <fieldset id="Fieldset2" runat="server" class="formBoxGV" style="height: 85px">
                        <legend>
                            <asp:Label ID="Label2" runat="server" Text="Inward Return"></asp:Label></legend>
                        <asp:LinkButton CssClass="linkButton" OnClick="LinkButtonClicked" runat="server"
                            ID="linkReturn">Completed (0)</asp:LinkButton>

                        <asp:LinkButton CssClass="linkButton" OnClick="LinkButtonClicked" runat="server"
                            ID="linkReturnBrigde">Bridge Error (0)</asp:LinkButton>
                ...
                <Columns>
                    <asp:TemplateField HeaderText="">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:HiddenField ID="hdEdrOutId2" runat="server" Value='<%# Eval("EdrOutId") %>' />
                    ...
                    <asp:TemplateField HeaderText="">
                        ...
                        <ItemTemplate>                            
                            ...
                            <asp:LinkButton ID="LinkButtonReverse" runat="server" ForeColor="Red" OnClientClick="return window.confirm('Are you sure to Reverse the item?');"
                                OnClick="ButtonReverseClick">Reverse</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
