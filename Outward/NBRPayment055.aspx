<%@ Page Title="NBR Payment" Language="C#" AutoEventWireup="true" MasterPageFile="~/Site.Master" CodeBehind="NBRPayment055.aspx.cs" Inherits="RtgsWeb.Outward.NBRPayment055" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('#tbSenderAcc').limit('16', '#sendAc');
            $('#tbSenderName').limit('70', '#sendName');
            $('#tbRcvName').limit('70', '#recvName');
            $('#txtPurpose').limit('35', '#spanPurpose');
        });
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
            ...
            <tr>
                <td style="width: 800px" valign="top">
                    ...
                    <table style="width: 100%" cellpadding="8" cellspacing="0" class="dataEntryTable">
                        <tr class="evenRow">
                            <td style="width: 160px">Transaction Type
                            </td>
                            <td>Single Customer Payment Transfer (RTGS_SSCT)
                            </td>
                            <%--<td>
                        ...
                        <tr class="evenRow">
                            <td>Sender Account (<span id="sendAc"></span>)
                            </td>
                            <td>
                        ...
                        <asp:Panel runat="server" ID="panelSenderName">
                            <tr class="oddRow">
                                <td>Sender Name (<span id="sendName"></span>)
                                </td>
                                <td>
                            ...
                            <tr class="oddRow">
                                ...
                                <td>
                                    <asp:TextBox ID="tbBalance" Width="180px" runat="server" CssClass="textBox" ReadOnly="True"></asp:TextBox>
                                    <asp:Label runat="server" ID="lbAccOpMode"></asp:Label>
                                </td>
                            </tr>
                        </asp:Panel>
                        <tr class="evenRow">
                        ...
                        <tr class="evenRow">
                            <td>Purpose (<span id="spanPurpose"></span>)
                            </td>
                            <td>
                ...
                <td valign="top" style="padding: 0px 20px">
                    <img id="imgSign" runat="server" visible="true" src="/media/images/sign2.png" width="250"
    ...
    <fieldset class="formBoxGV">
        ...
        <table width="800px" class="dataEntryTable" cellpadding="8" cellspacing="0">
            <tr class="oddRow">
                <td style="width: 160px">Receiver Bank
                </td>
                <td>
            ...
            <tr class="evenRow">
                <td colspan="1">Receiver A/C ( <span id="recvAc"></span>)
                </td>
                <td>
            ...
            <asp:Panel runat="server" ID="panelRecvName">
                <tr class="oddRow">
                    <td>Receiver Name ( <span id="recvName"></span>)
                    </td>
                    <td colspan="1">
    ...
    <fieldset>
        ...
        <table width="800px" class="dataEntryTable" cellpadding="8" cellspacing="0">
            <tr class="evenRow">
                <td style="width: 160px">Customs Office Code (3 chars)
                </td>
                <td>
                    <asp:TextBox runat="server" ID="tb_CustomsOfficeCode" MaxLength="3"/>
                    <asp:RegularExpressionValidator  ControlToValidate = "tb_CustomsOfficeCode" 
                        ID="RegularExpressionValidator1" ValidationExpression = "^[\s\S]{3}$" runat="server" 
            ...
            <tr class="evenRow">
                <td colspan="1">Mobile Number (11 digits)
                </td>
                <td>
                    <asp:TextBox ID="tb_CustomerMobileNumber" Width="220px" runat="server" MaxLength="11" CssClass="textBox"></asp:TextBox>
                     <asp:RegularExpressionValidator  ControlToValidate = "tb_CustomerMobileNumber" 
                        ID="RegularExpressionValidator5" ValidationExpression = "^[\s\S]{11}$" runat="server" 
