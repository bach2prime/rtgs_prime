<%@ Page Title="RTGS Inward: Status" Language="C#" MasterPageFile="~/Site.Master"
    AutoEventWireup="true" CodeBehind="ItemStatus170.aspx.cs" Inherits="RtgsWeb.Inward.ItemStatus170"
            ...
            <tr>
                ...
                <td style="width: 30%">
                    <fieldset id="Fieldset2" runat="server" class="formBoxGV">
                        <legend>
                            <asp:Label ID="Label2" runat="server" Text="Reverse"></asp:Label>
                        </legend>
                        <asp:LinkButton CssClass="linkButton" OnClick="LinkButtonClicked" runat="server"
                ...
                <Columns>
                    <asp:TemplateField HeaderText="">
                        ...
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="LinkButtonCreateOutward" runat="server" ForeColor="Red" 
                            OnClientClick="return window.confirm('Are you sure to Create Outward item?');"
                                OnClick="ButtonCreateOutwardClick">Create Outward</asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                    ...
                    <asp:BoundField DataField="BbMessage" HeaderText="BB Message" />
                </Columns>
