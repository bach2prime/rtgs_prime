<%@ Page Title="Report" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true"
    CodeBehind="Report.aspx.cs" Inherits="RtgsWeb.Report.Report" Culture="bn-BD"
    UICulture="bn-BD" %>
                ...
                <tr>
                    ...
                    <td style="padding-right: 5px;">
                        <asp:DropDownList ID="ddlReportName" runat="server" Font-Names="Segoe UI" Font-Size="9pt"
                            Width="200px" OnSelectedIndexChanged="ddlReportName_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>&nbsp;
                        <asp:DropDownList runat="server" ID="ddlCurrency" />                      
                        
                    </td>
                    <td style="text-align: right" id="DateSection1" runat="server">
                        Date:
                        <asp:DropDownList ID="ddlDate" runat="server" AutoPostBack="false" Width="115px"
                            Font-Names="Segoe UI" Font-Size="8pt">
                        </asp:DropDownList>
                    </td>
                    <td style="text-align: right" id="DateSection2" runat="server">
                    ...
                    <td style="text-align: left" id="DateSection3" runat="server">
                        To
